...
- Create `.env.local` with `NEXT_PUBLIC_SUPABASE_AUTH_URL`, `NEXT_PUBLIC_SUPABASE_AUTH_ANON_KEY`, `NEXT_PUBLIC_SUPABASE_DATA_URL`, `NEXT_PUBLIC_SUPABASE_DATA_ANON_KEY`, `OPENAI_API_KEY`
